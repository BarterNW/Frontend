...
function LoginForm() {
  ...
  useEffect(() => {
    ...
    router.push(`/login?type=${userType}`, { scroll: false });
  }, [userType, router]);
  ...
  const pageContent = {
    organizer: {
      title: "Log In as Event Organizer",
      subtitle: "Find sponsors and power your events",
      emailPlaceholder: "organizer@example.com",
      carouselTitle: "Zero Commissions",
      carouselDescription: "List your events for free and connect with sponsors instantly. No hidden fees, no commission charges.",
      carouselItems: [
        {
          icon: "📊",
          title: "Zero Commissions",
          description: "List your events for free and connect with sponsors instantly. No hidden fees, no commission charges."
        },
        {
          icon: "🎯",
          title: "Smart Matching",
          description: "Our AI matches you with sponsors who align with your event values and audience."
        },
        {
          icon: "⚡",
          title: "Fast Setup",
          description: "Get your event listed in minutes and start receiving sponsorship proposals immediately."
        }
      ]
    },
    brand: {
      title: "Log In as Brand",
      subtitle: "Discover events that match your audience",
      emailPlaceholder: "brand@company.com",
      carouselTitle: "Targeted Reach",
      carouselDescription: "Connect with verified events that match your brand values and target audience. Every sponsorship backed by real data.",
      carouselItems: [
        {
          icon: "🎯",
          title: "Targeted Reach",
          description: "Connect with verified events that match your brand values and target audience."
        },
        {
          icon: "📈",
          title: "Track ROI",
          description: "Real-time analytics and reporting to measure the impact of your sponsorships."
        },
        {
          icon: "🤝",
          title: "Direct Deals",
          description: "Connect directly with organizers without middlemen or commission fees."
        }
      ]
    }
  };
      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link href="/forgot-password" className="text-sm text-[#061C47] hover:underline">
              Forgot Password?
            </Link>
          </div>
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          ...
          <Link href={`/signup?type=${userType}`} className="text-[#061C47] font-semibold hover:underline">
            Sign Up
          </Link>
        </p>
        ...
        <div className="mt-8 pt-6 border-t border-gray-300">
          ...
          <p className="text-sm text-gray-400 mt-2">2025 © BarterNow</p>
        </div>
      </div>
    </AuthLayout>
  );
